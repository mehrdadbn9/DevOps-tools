...
We can use `mehrdadbiukian.ir` domain for api-server load balancer.
...
domain_name=mehrdadbiukian.ir
master1_ip=10.10.10.1
master2_ip=10.10.10.2
master3_ip=10.10.10.3
master1_name=adm-master1
master2_name=adm-master2
master3_name=adm-master3
vip_api_name=mehrdadbiukian.ir
...
- set proxy for bash
- set no-proxy 
- update kuebadm version and related file