...
-e MYSQL_DATABASE=Mehrdad \
-e MYSQL_USER=Mehrdad \
...
-e WORDPRESS_DB_USER=Mehrdad \
-e WORDPRESS_DB_NAME=Mehrdad \
wordpress:latest
...
server {
  listen 443;
  server_name wp.Mehrdadbiukian.ir;
  ...
  location / {
    ...
    add_header X-Powered-By "mehrdad biukian | mehrdadbiukian.ir";
    }
 }
...
-subj "/C=IR/ST=Iran/L=Tehran/O=DockerMe/OU=IT/CN=mehrdadbiukian.ir/emailAddress=mehrdadbiukian@gmail.com" \
...
services:
  ...
  wordpress:
    ...
    environment:
      ...
      WORDPRESS_DB_USER: Mehrdad
      WORDPRESS_DB_NAME: Mehrdad
